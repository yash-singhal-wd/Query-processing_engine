...
class BufferManager{
    ...
    Page getPage(string tableName, string pageIndex);
    ...
    void writePage(string tableName, string pageIndex, vector<vector<int>> rows, int rowCount);
    void writePage1(string tableName, string pageIndex, vector<vector<int>> rows, int rowCount);
    void writePage_final_wave(string tableName, string pageIndex, vector<vector<int>> rows, int rowCount);
    void writePage_customFolder(string folder, string tableName, string pageIndex, vector<vector<int>> rows, int rowCount);
